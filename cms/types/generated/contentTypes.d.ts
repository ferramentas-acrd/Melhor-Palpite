...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content type para autores';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#dc2626'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
...
export interface ApiCustomPageCustomPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'P\u00E1ginas personalizadas com layout customizado';
  ...
  attributes: {
    content_blocks: Schema.Attribute.Component<'page.content-block', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    hero_section: Schema.Attribute.Component<'page.hero-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    show_sidebar: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    sidebar_widgets: Schema.Attribute.Component<'widget.sidebar-widget', true>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    template: Schema.Attribute.Enumeration<
      ['default', 'full_width', 'landing_page', 'contact', 'about']
    > &
...
export interface ApiHomeWidgetHomeWidget extends Struct.CollectionTypeSchema {
  collectionName: 'home_widgets';
  info: {
    description: 'Widgets personaliz\u00E1veis para a p\u00E1gina inicial';
    displayName: 'Home Widget';
    pluralName: 'home-widgets';
    singularName: 'home-widget';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    css_classes: Schema.Attribute.String;
    custom_html: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-widget.home-widget'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    position: Schema.Attribute.Enumeration<
      ['hero', 'sidebar', 'content_top', 'content_bottom', 'footer_top']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    widget_type: Schema.Attribute.Enumeration<
      [
        'latest_posts',
        'featured_posts',
        'category_posts',
...
export interface ApiMenuNavigationMenuNavigation
  extends Struct.CollectionTypeSchema {
  collectionName: 'menu_navigations';
  info: {
    description: 'Gerenciamento de menus do site';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    position: Schema.Attribute.Enumeration<['header', 'footer', 'sidebar']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiNoticiaNoticia extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content type para not\u00EDcias do portal';
    displayName: 'Not\u00EDcia';
    pluralName: 'noticias';
...
export interface ApiSiteFooterSiteFooter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configura\u00E7\u00F5es do footer do site';
  ...
  attributes: {
    alternative_logo: Schema.Attribute.Media<'images'>;
    copyright_text: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    newsletter_action_url: Schema.Attribute.String;
    newsletter_description: Schema.Attribute.Text;
    newsletter_signup: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configura\u00E7\u00F5es globais do site';
  ...
  attributes: {
    ...
    analytics_code: Schema.Attribute.Text;
    ...
    social_media_links: Schema.Attribute.Component<'footer.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Tags para categoriza\u00E7\u00E3o de artigos';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::home-widget.home-widget': ApiHomeWidgetHomeWidget;
